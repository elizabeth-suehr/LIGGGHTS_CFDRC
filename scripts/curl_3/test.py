...
steps     	= 60000000      			# Number of simulation steps after initialization
...
dtrelax         = 0.2                                  # time step relaxation (dt=dtrelax*dt_stable)
...
for j in range(npoints):
    ...
    lebc.pbs_files_specific(j,total,nodes,proc[0]*proc[1]*proc[2],"","16:00:00","normal","liz.suehr","lmp_auto","shear", "module load /home/liz.suehr/modules/openmpi/1.10.7\nmodule load /home/liz.suehr/modules/vtk/8.2.0\n")
# lebc.del_globals()
