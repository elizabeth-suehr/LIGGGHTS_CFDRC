...
amin            = 0.025					# Minimum volume fraction per species
...
filestr         = "rod2" 	  			# Base filename string for input files
E		= 8.7e9					# LIGGGHTS parameter Young's modulus for all particles
nu		= 0.3					# LIGGGHTS parameter Poisson's ratio for all particles
steps     	= 18000000      			# Number of simulation steps after initialization
shearStr        = 100.0					# Shear strain rate to apply for shear simulations
lens            = 2.8e-5                               # representative length scale, bounding box length/largest size. Can be used to control #particles for a fixed volume
lebc_band       = 0.15
lebc_latt       = 0
...
lebc.pbs_files(1,18,18,"","16:00:00","normal","liz.suehr","lmp_auto","shear", "module load /home/liz.suehr/modules/openmpi/1.10.7\nmodule load /home/liz.suehr/modules/vtk/8.2.0\n")
