...
lens            = 0.00014*2.0                          # representative length scale, bounding box length/largest size. Can be used to control #particles for a fixed volume
lebc_band       = 0.15
lebc_latt       = 0
...
lebc.pbs_files(1,32,32,"","16:00:00","normal","liz.suehr","lmp_auto","shear", "module load /home/liz.suehr/modules/openmpi/1.10.7\nmodule load /home/liz.suehr/modules/vtk/8.2.0\n")
