...
namespace LAMMPS_NS
{
  ...
  public:
    ...
    double *eatom, **vatom, **force_length, **overlap; // accumulated per-atom energy/virial
  ...
  public: // FIXME: was protected
    ...
    int vflag_fdotr;
    int maxeatom, maxvatom, maxforce_length;

    virtual void ev_setup(int, int);
    void pre_init_lebc();
    void lebc_setup();
    void force_length_tally(int, int, int, int, double, double, double, double, double, double, double, double);
    void ev_unset();
