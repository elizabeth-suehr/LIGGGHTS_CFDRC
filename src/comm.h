...
namespace LAMMPS_NS
{
    ...
    public:
        ...
        int procs[4] = {-1};
        int recv_proc_2_num = 0;
        int send_proc_2_num = 0;
        int first_recv_2_num = 0;
        bool doub_recv[2] = {false, false};
        ...
        int location_to_proc(double *); // move atoms to new procs
        void get_lebc_procs();          // send in a int[4] get proc numbers
    ...
    protected:
        ...
        bool decide_lebc(double *buf, int dim, double lo, double hi, int ineed);
