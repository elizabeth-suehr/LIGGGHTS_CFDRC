...
filestr         = "rod6mm" 	  			# Base filename string for input files
E		= 7.9e9					# LIGGGHTS parameter Young's modulus for all particles
...
lens            = 4.2e-5                               # representative length scale, bounding box length/largest size. Can be used to control #particles for a fixed volume
lebc_band       = 0.15
lebc_latt       = 0
...
lebc.pbs_files(1,18,18,"","16:00:00","normal","liz.suehr","lmp_auto","shear", "module use -a /home/rxl/local/modules\nmodule purge\nmodule load openmpi\nmodule load vtk\n")
